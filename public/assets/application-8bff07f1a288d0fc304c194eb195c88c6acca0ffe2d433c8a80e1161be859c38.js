...
(function() {
  window.SummerNoteComponent = (function() {
    function SummerNoteComponent() {}

    SummerNoteComponent.bind_enter_key = function() {
      var form;
      form = $(this.selector).closest('form');
    ...
    SummerNoteComponent.init = function(selector, height) {
      this.selector = selector;
...
(function() {
  ...
  App.init = function() {
    return SummerNoteComponent.init('[data-provider="summernote"]', '400px');
  };
...
(function() {
  window.App.ApplyToJob = {
    highlight_instructions: function(anchor_element) {
      $('body').animate({
        scrollTop: $(anchor_element).offset().top - 60
      }, 1000);
      anchor_element.classList.add("item-highlight");
      return setTimeout((function() {
        return anchor_element.classList.remove("item-highlight");
      }), 5200);
    }
  };
